...
static const unsigned short big5_forward[94][191] = {
    ...
    0x2223, 0xFFFD},
    {0xFFFD, 0xFF0F, 0xFF3C, 0xFF04, 0x00A5, 0x3012, 0x00A2, 0x00A3, 0xFF05, 
    ...
    0x3025, 0x3026, 0x3027, 0x3028, 0x3029, 0xFFFD, 0x5344, 0xFFFD, 0xFF21, 
...
static const struct { unsigned char r, c; } big5_backward[] = {
    ...
    {2,1}, {2,2}, {2,3}, {0,33}, {0,21}, {0,34}, {0,14}, {1,142}
};
...
int main(void)
{
     ...
     * work - the comments at the top of BIG5.TXT state this
     * explicitly. They say problems are to be expected at the
     * following locations:
     * 
     *   0xA15A == (0,26)
     *   0xA1C3 == (0,131)
